...
[AddComponentMenu("UI/Effects/HDR/HDR Shadow", 80)]
/// <summary>
/// Adds an hdr shadow to a graphic using IVertexModifier.
/// </summary>
public class HDRShadow : BaseMeshEffect
{
    [SerializeField]
    ...
    protected void ApplyShadowZeroAlloc(List<UIVertex> verts, Color color, int start, int end, float x, float y)
    {
        UIVertex vt;
    ...
    protected void ApplyShadow(List<UIVertex> verts, Color color, int start, int end, float x, float y)
    {
